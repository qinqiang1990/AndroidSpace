...
public class TestActivity extends ActionBarActivity {
    ...
    public class MyPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        private int offset;//间距

        public MyPageChangeListener() {

            DisplayMetrics dm = DensityUtil.getDisplay(TestActivity.this);
            this.cur = 0;
            this.offset = dm.widthPixels / 11;
            this.width = offset * 3;
        }
        ...
        public void onPageSelected(int position) {
            ...
            TranslateAnimation animation = new TranslateAnimation(begin, end, 0, 0);
            animation.setFillAfter(true);// TTrue:图片停在动画结束位置
